(function (i) {
  ...
  function A(a, b) {
    w === s &&
      (w =
        -1 === y.serializeToString(i.parseXML(B["xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"));
  ...
  o.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            j ||
              ...
              (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                ? (j = q(e, "c", { attr: { t: "n", r: f }, children: [q(e, "v", { text: a[b] })] }))
                : ((k = !k.replace ? k : k.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")),
                  (j = q(e, "c", {
                    attr: { t: "inlineStr", r: f },
                    children: {
                      row: q(e, "is", {
                        children: {
                          row: q(e, "t", { text: k, attr: { "xml:space": "preserve" } }),
                        },
                      }),
                    },
                  }))));
      ...
      for (o = d.header.length; k < o; k++)
        r.appendChild(
          q(e, "col", { attr: { min: k + 1, max: k + 1, width: K(d, k), customWidth: 1 } })
        );
